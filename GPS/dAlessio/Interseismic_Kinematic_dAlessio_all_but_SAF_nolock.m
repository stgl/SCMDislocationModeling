...
SG_filename= 'SG_slip_nolock.msh';
RC_H_filename= 'RC_H_slip_nolock.msh';
WN_filename= 'WN_slip_nolock.msh';
C_north_filename= 'C_north_slip_nolock.msh';
C_cen_south_filename= 'C_cen_south_slip_nolock.msh';
GV_Con_filename= 'GV_Con_slip_nolock.msh';
Gr_filename= 'Gr_slip_nolock.msh';
VM_filename= 'VM_slip_lt.msh';

nr_locked_faults=8;
nr_creeping_faults=0;

faultnames=[SG_filename,' ',RC_H_filename,' ',WN_filename, ' ',...
    C_north_filename, ' ',C_cen_south_filename,' ',GV_Con_filename,' ',...
    Gr_filename,' ',VM_filename];
