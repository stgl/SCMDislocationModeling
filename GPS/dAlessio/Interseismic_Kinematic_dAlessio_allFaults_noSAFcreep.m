base_filename = strcat('results/all_noSAFCreep/');
...
faultnames=['SAF_SF_Pen_SCM_SJB.msh', ' ','SG_slip_lt.msh',' ','RC_H_slip_lt.msh', ...
  ' ','WN_slip_lt.msh',' ','C_north_slip_lt.msh',' ','C_cen_south_slip_lt.msh', ...
  ' ','GV_Con_slip_lt.msh',' ','Gr_slip_lt.msh',' ','VM_slip_lt.msh',' ',...
  'H_creep.msh',' ','C_north_creep.msh',' ','C_cen_south_creep.msh',' ',...
  'GV_Con_creep.msh'];
